...
class ProcessPdf:
    ...
    def add_data_to_pdf(self, template_path, data, FORM_KEYS):
        print('\nAdding data to pdf...')
...
pdf = ProcessPdf(r'C:\Users\Mathi\Documents\Coding\TempPdfs', "filled_pdf.pdf")
data = {
...
data_pdf = pdf.add_data_to_pdf(r'C:\Users\Mathi\Documents\Coding\PDF_Templates\Test_Contract', data, FORM_KEYS)
temp_files.append(data_pdf)

#new_pdf_path = ProcessPdf("C:\Users\Mathi\Documents\Coding\TempPdfs", "filled_pdf.pdf")
#new_pdf_path.add_data_to_pdf()